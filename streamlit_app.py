...
if st.session_state.phase == 'intro':
    ...
    **Welcome to the Visual Turing Test for Vitreous OCT Images!**
    ...
    2. Comparing 10 pairs of images, one real ART10 and one enhanced version generated by a model, to assess whether the anatomical structures present in the ART10 image have been preserved in the generated enhanced version, and potential issues that you may notice in the generated image.
