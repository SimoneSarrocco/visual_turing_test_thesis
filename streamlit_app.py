...
def display_images(left, right, phase='comparison'):
    ...
    with col1:
        if phase == 'comparison':
            ...
            caption = "ART10" if "inputs" in left else "Model output"
        st.image(left, width=384, caption=caption)
    with col2:
        if phase == 'comparison':
            caption = "Image B"
        else:
            caption = "Model output" if "outputs" in right else "ART10"
...
if st.session_state.phase == 'intro':
    ...
    **Welcome to the Visual Turing Test for Vitreous OCT Images!**
    ...
    This test is part of the Master's Thesis of Simone Sarrocco from the University of Basel, Switzerland, and University of Bologna, Italy.
    ...
    2. Assessing 10 pairs of images for preservation of anatomical structures and potential issues.
    ...
    **IMPORTANT**: Please activate "Wide Mode" for optimal image viewing.
    ...
    At the end of the test, please click on "Download your answers" and send the .csv file to either philippe.valmaggia@unibas.ch or simone.sarrocco@unibas.ch
    """)
